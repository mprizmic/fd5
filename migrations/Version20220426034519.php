 ...
 */
final class Version20220426034519 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE primaria CHANGE duracion duracion VARCHAR(15) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE primaria CHANGE duracion duracion VARCHAR(10) DEFAULT NULL');
