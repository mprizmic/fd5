 ...
 */
final class Version20220401180313 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE edificio ADD distrito_escolar_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_DED4A4E862E97D21 ON edificio (distrito_escolar_id)');
        $this->addSql('ALTER TABLE vecino CHANGE edificio_id edificio_id INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_DED4A4E862E97D21 ON edificio');
        $this->addSql('ALTER TABLE edificio DROP distrito_escolar_id, CHANGE referencia referencia VARCHAR(50) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE slug slug VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE vecino CHANGE edificio_id edificio_id INT DEFAULT NULL, CHANGE nombre nombre VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
