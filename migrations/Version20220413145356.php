 ...
 */
final class Version20220413145356 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tipo_formacion (id INT AUTO_INCREMENT NOT NULL, codigo VARCHAR(2) DEFAULT NULL, descripcion VARCHAR(25) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE domicilio_localizacion CHANGE creado creado DATETIME NOT NULL');
        $this->addSql('ALTER TABLE establecimiento CHANGE creado creado DATETIME NOT NULL');
        $this->addSql('ALTER TABLE localizacion CHANGE creado creado DATETIME NOT NULL');
        $this->addSql('ALTER TABLE unidad_educativa CHANGE creado creado DATETIME NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE tipo_formacion');
        ...
        $this->addSql('ALTER TABLE unidad_educativa CHANGE descripcion descripcion VARCHAR(30) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE creado creado DATETIME DEFAULT NULL');
