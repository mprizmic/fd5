 ...
 */
final class Version20220407142100 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE localizacion (id INT AUTO_INCREMENT NOT NULL, unidad_educativa_id INT NOT NULL, actualizado DATETIME DEFAULT NULL, creado DATETIME NOT NULL, INDEX IDX_5512F061BF20CF2F (unidad_educativa_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
