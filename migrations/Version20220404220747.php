 ...
 */
final class Version20220404220747 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE establecimiento_edificio ADD establecimiento_id INT DEFAULT NULL, ADD edificio_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE establecimiento_edificio ADD CONSTRAINT FK_37D12C6571B61351 FOREIGN KEY (establecimiento_id) REFERENCES establecimiento (id)');
        $this->addSql('ALTER TABLE establecimiento_edificio ADD CONSTRAINT FK_37D12C658A652BD6 FOREIGN KEY (edificio_id) REFERENCES edificio (id)');
        $this->addSql('CREATE INDEX IDX_37D12C6571B61351 ON establecimiento_edificio (establecimiento_id)');
        $this->addSql('CREATE INDEX IDX_37D12C658A652BD6 ON establecimiento_edificio (edificio_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE establecimiento_edificio DROP FOREIGN KEY FK_37D12C6571B61351');
        $this->addSql('ALTER TABLE establecimiento_edificio DROP FOREIGN KEY FK_37D12C658A652BD6');
        $this->addSql('DROP INDEX IDX_37D12C6571B61351 ON establecimiento_edificio');
        $this->addSql('DROP INDEX IDX_37D12C658A652BD6 ON establecimiento_edificio');
        $this->addSql('ALTER TABLE establecimiento_edificio DROP establecimiento_id, DROP edificio_id, CHANGE cue_anexo cue_anexo VARCHAR(2) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE nombre nombre VARCHAR(50) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE te te VARCHAR(50) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE referente_sga referente_sga VARCHAR(200) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
