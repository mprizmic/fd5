 ...
 */
final class Version20220331210907 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vecino ADD edificio_id INT ');
        $this->addSql('ALTER TABLE vecino ADD CONSTRAINT FK_758D25E08A652BD6 FOREIGN KEY (edificio_id) REFERENCES edificio (id)');
        $this->addSql('CREATE INDEX IDX_758D25E08A652BD6 ON vecino (edificio_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_758D25E08A652BD6 ON vecino');
        $this->addSql('ALTER TABLE vecino DROP edificio_id, CHANGE nombre nombre VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
