 ...
 */
final class Version20220405144940 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE domicilio (id INT AUTO_INCREMENT NOT NULL, calle VARCHAR(50) NOT NULL, altura VARCHAR(5) NOT NULL, principal TINYINT(1) DEFAULT NULL, c_postal VARCHAR(8) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
