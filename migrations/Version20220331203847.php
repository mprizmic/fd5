 ...
 */
final class Version20220331203847 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cgp (id INT AUTO_INCREMENT NOT NULL, numero VARCHAR(6) DEFAULT NULL, UNIQUE INDEX UNIQ_CF692037F55AE19E (numero), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
