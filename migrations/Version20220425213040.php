 ...
 */
final class Version20220425213040 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE oferta_educativa ADD sdf_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE oferta_educativa ADD CONSTRAINT FK_21B7C831D78BBBBC FOREIGN KEY (sdf_id) REFERENCES sdf (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_21B7C831D78BBBBC ON oferta_educativa (sdf_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE oferta_educativa DROP FOREIGN KEY FK_21B7C831D78BBBBC');
        $this->addSql('DROP INDEX UNIQ_21B7C831D78BBBBC ON oferta_educativa');
        $this->addSql('ALTER TABLE oferta_educativa DROP sdf_id');
