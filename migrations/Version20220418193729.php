 ...
 */
final class Version20220418193729 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE carrera RENAME INDEX idx_41e9a8c0432ad46e TO IDX_CF1ECD30432AD46E');
        $this->addSql('ALTER TABLE carrera RENAME INDEX uniq_41e9a8c0fafbf624 TO UNIQ_CF1ECD30FAFBF624');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE carrera RENAME INDEX idx_cf1ecd30432ad46e TO IDX_41E9A8C0432AD46E');
        $this->addSql('ALTER TABLE carrera RENAME INDEX uniq_cf1ecd30fafbf624 TO UNIQ_41E9A8C0FAFBF624');
