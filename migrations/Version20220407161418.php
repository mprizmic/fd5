 ...
 */
final class Version20220407161418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE domicilio_localizacion ADD domicilio_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_DABAA005166FC4DD ON domicilio_localizacion (domicilio_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_DABAA005166FC4DD ON domicilio_localizacion');
        $this->addSql('ALTER TABLE domicilio_localizacion DROP domicilio_id');
