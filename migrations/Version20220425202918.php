 ...
 */
final class Version20220425202918 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE oferta_educativa ADD CONSTRAINT FK_21B7C831C671B40F FOREIGN KEY (carrera_id) REFERENCES carrera (id)');
