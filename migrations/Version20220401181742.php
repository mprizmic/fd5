 ...
 */
final class Version20220401181742 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE establecimiento_edificio (id INT AUTO_INCREMENT NOT NULL, cue_anexo VARCHAR(2) NOT NULL, nombre VARCHAR(50) DEFAULT NULL, fecha_creacion DATE DEFAULT NULL, fecha_baja DATE DEFAULT NULL, te VARCHAR(50) DEFAULT NULL, referente_sga VARCHAR(200) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE establecimiento_edificio');
