 ...
 */
final class Version20220405190049 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE barrio (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(50) NOT NULL, abreviatura VARCHAR(5) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE edificio ADD barrio_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE edificio ADD CONSTRAINT FK_DED4A4E8DBA79E2A FOREIGN KEY (barrio_id) REFERENCES barrio (id)');
        $this->addSql('CREATE INDEX IDX_DED4A4E8DBA79E2A ON edificio (barrio_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_DED4A4E8DBA79E2A ON edificio');
        $this->addSql('ALTER TABLE edificio DROP barrio_id, CHANGE referencia referencia VARCHAR(50) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE slug slug VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
