 ...
 */
final class Version20220407151954 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE localizacion ADD establecimiento_edificio_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_5512F061E0B84520 ON localizacion (establecimiento_edificio_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_5512F061E0B84520 ON localizacion');
        $this->addSql('ALTER TABLE localizacion DROP establecimiento_edificio_id');
