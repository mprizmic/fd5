 ...
 */
final class Version20220405191407 extends AbstractMigration {
    ...
    public function up(Schema $schema): void {
        ...
        $this->addSql("delete from barrio");
        $this->addSql("INSERT INTO fd5.barrio (nombre,abreviatura ) VALUES 
	 ('Palermo','PAL' ),
	 ('Almagro','ALM' ),
	 ('Flores','FLO' ),
	 ('Villa Urquiza','URQ' ),
	 ...
	 ('Nueva Pompeya','POM' ),
	 ('Núñez','NUÑ' ),
	 ('Parque Avellaneda','AVE' ),
	 ('Parque Chacabuco','CHA' ),
	 ('Parque Chas','CHS' ),
	 ('Parque Patricios','PPA' ),
	 ('Puerto Madero','PMA' ),
	 ('Recoleta','REC' );");
        $this->addSql("INSERT INTO fd5.barrio (nombre,abreviatura ) VALUES
	 ('Retiro','RET' ),
	 ...
	 ('Versalles','VER' ),
	 ('Villa Crespo','VCR' ),
	 ('Villa del Parque','VDP' ),
	 ('Villa Devoto','VDV' );");   
        $this->addSql("INSERT INTO fd5.barrio (nombre,abreviatura ) VALUES
	 ('Villa General Mitre','VGM' );");
    }
