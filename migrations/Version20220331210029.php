 ...
 */
final class Version20220331210029 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE vecino (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, actualizado DATETIME NOT NULL, creado DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
