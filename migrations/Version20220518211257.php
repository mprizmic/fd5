 ...
 */
final class Version20220518211257 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE primaria ADD nombre VARCHAR(50) NOT NULL, DROP descripcion');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE primaria ADD descripcion VARCHAR(255) NOT NULL, DROP nombre');
