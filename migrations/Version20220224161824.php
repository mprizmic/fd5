 ...
 */
final class Version20220224161824 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE aviso (id INT AUTO_INCREMENT NOT NULL, descripcion VARCHAR(250) DEFAULT NULL, fecha DATE NOT NULL, activo TINYINT(1) DEFAULT NULL, INDEX aviso_fecha_IDX (fecha), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_94A4D17E989D9B62 ON establecimiento (slug)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_94A4D17E989D9B62 ON establecimiento');
