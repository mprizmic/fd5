 ...
 */
final class Version20220408181613 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE domicilio_localizacion ADD localizacion_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_DABAA005C851F487 ON domicilio_localizacion (localizacion_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_DABAA005C851F487 ON domicilio_localizacion');
        $this->addSql('ALTER TABLE domicilio_localizacion DROP localizacion_id');
